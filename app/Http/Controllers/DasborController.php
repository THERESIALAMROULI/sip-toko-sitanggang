...
{
    // Dashboard mengumpulkan seluruh indikator penting agar kondisi toko bisa dipantau dari satu halaman.
    public function index()
    {
        $today = now()->toDateString();
        // Ringkasan harian dipakai untuk melihat performa penjualan pada hari berjalan.
        ...
        $outstandingReceivables = Piutang::query()
            ->where('status', 'belum')
            ->sum('jumlah');
        // Perbandingan bulan ini dan bulan lalu dipakai untuk menghitung tren pertumbuhan penjualan.
        ...
        // Data transaksi terbaru dan stok menipis membantu operasional harian mengambil tindakan cepat.
        ...
        $outOfStockCount = Produk::query()
            ...
            ->where('stok', '<=', 0)
            ->count();
        // Query dasar piutang jatuh tempo dipakai ulang agar perhitungan jumlah, nominal, dan daftar tetap konsisten.
        ...
        $overdueReceivables = (clone $overdueBaseQuery)
            ...
            ->limit(6)
            ->get();
        // Bagian owner menyusun data 12 bulan terakhir untuk grafik penjualan dan piutang.
        ...
        $ownerReceivableTrendValues = $ownerMonthKeys
            ...
            ->values()
            ->all();
        // Produk terlaris dan piutang tertua dipakai sebagai dasar evaluasi bisnis pemilik toko.
        ...
        $ownerOldestReceivables = Piutang::query()
            ...
            ->limit(5)
            ->get();
        // Semua data ringkasan dikirim ke halaman dashboard untuk ditampilkan sebagai kartu dan grafik.
