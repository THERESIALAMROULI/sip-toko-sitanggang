...
{
    use HasFactory;
    // Model piutang menyimpan tagihan dari transaksi kredit sampai status pelunasannya berubah.
    ...
    // Accessor dan mutator ini menyamakan istilah di kode dengan struktur kolom yang dipakai database.
    ...
    // Relasi ini memudahkan penelusuran piutang ke transaksi asal dan pelanggan yang berutang.
